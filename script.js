    ...
    function initCalendar() {
        ...
        for (let i = 1; i <= lastDate; i++) {
            ...
            eventsArr.forEach((eventObj) => {
                if (eventObj == i + " " + months[month] + " " + year) {
                    event = true;
                }
            });
            if (
    ...
    document
        ...
        .addEventListener("submit", function (event) {
            ...
            if (
                ...
                alert(
                    "The event start time must be earlier than the end time."
                );
                return;
            }
            ...
            if (
                ...
                alert(
                    "The event start time must be earlier than the current time."
                );
                return;
            }
